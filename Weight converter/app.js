...
button.addEventListener('click', function(){
    ...
    if(gram == '' || isNaN(gram)){
        ...
        document.getElementById('error').innerHTML = "Please provise a valid gram";
        ...
        function convert_kilogram(gram){
            ...
            kilogram = gram * rate;
            document.getElementById('output').innerHTML = gram + "grams ="+ kilogram.toFixed(3) + 'kilogram.';
        }
